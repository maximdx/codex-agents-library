...
```bash
# Codex prompt: Create E2E tests
codex "Spawn e2e_tester to create Playwright tests for user registration and login flows"

# Add visual testing
codex "Spawn e2e_tester to add visual regression tests for the checkout page using Playwright"
```

### Inside a Codex session

```text
Spawn e2e_tester to create Cypress tests for our e-commerce checkout flow with payment integration
```
...
- Requires a runnable environment to execute tests; otherwise provide test code and verification steps
