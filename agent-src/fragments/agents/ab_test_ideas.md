...
```bash
# Codex prompt: Example 1: Improve conversion rate
codex "Spawn ab_test_ideas to design A/B tests to improve checkout conversion rate on our e-commerce site"

# Example 2: Onboarding optimization
codex "Spawn ab_test_ideas to generate test ideas for reducing user drop-off during app onboarding"

# Example 3: Feature validation
codex "Spawn ab_test_ideas to design an experiment to test if adding social proof increases sign-ups"
```

### Inside a Codex session

```text
Spawn ab_test_ideas to create A/B test hypotheses for improving email click-through rates
```

**Example scenarios:**
- **Pricing Page**: `Spawn ab_test_ideas to test different pricing display strategies to maximize conversions`
- **CTA Optimization**: `Spawn ab_test_ideas to design tests for our call-to-action button variations`
- **Content Strategy**: `Spawn ab_test_ideas to experiment ideas for testing short vs long-form product descriptions`
