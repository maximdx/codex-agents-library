...
```bash
codex "Spawn debug_detective to analyze this NullPointerException stack trace"
codex "Spawn debug_detective to why is my React component re-rendering infinitely?"
```
