...
```bash
# Codex prompt: Example 1: Convert Figma design to HTML/CSS
codex "Spawn figma_to_html to convert this Figma design to HTML and CSS: [Figma URL]"

# Example 2: Generate React components
codex "Spawn figma_to_html to convert this Figma component library to React TypeScript components: [Figma URL]"

# Example 3: Extract design system
codex "Spawn figma_to_html to analyze this Figma file and extract the design system as CSS custom properties: [Figma URL]"
```

### Inside a Codex session

```text
Spawn figma_to_html to convert this landing page design to Next.js components with Tailwind CSS
```

**Example scenarios:**
- **Landing Page**: `Spawn figma_to_html to convert this hero section to HTML with modern CSS animations`
- **Dashboard UI**: `Spawn figma_to_html to create React components for this admin dashboard layout`
- **Component Library**: `Spawn figma_to_html to build a button component with all variants from this Figma file`
- **Design System**: `Spawn figma_to_html to extract the color palette and typography system from this design`
...
- Private Figma files require proper permissions or API access
